  ...
  const handleSocialLogin = async (provider: "google") => {
    try {
      ...
      if (provider === "google") {
        ...
        // OAuth redirect will handle rest
      }
    } catch (err: any) {
      setError(err?.message || "Gagal login menggunakan provider");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-3xl p-8 w-full max-w-md mx-4 shadow-2xl">
        ...
        {/* Content */}
        <h2 className="text-3xl font-extralight text-center mb-8">Sign In</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-right">
            <button
              ...
              onClick={() =>
                toast.info(
                  "Saat ini fitur sedang dalam pengembangan",
                  "Mohon Maaf!"
                )
              }
